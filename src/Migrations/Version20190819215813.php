 ...
 */
final class Version20190819215813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE slids (id INT AUTO_INCREMENT NOT NULL, links VARCHAR(255) DEFAULT NULL, imgs VARCHAR(255) DEFAULT NULL, header VARCHAR(100) DEFAULT NULL, paragraf VARCHAR(255) DEFAULT NULL, status VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
