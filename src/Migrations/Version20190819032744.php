 ...
 */
final class Version20190819032744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE kullanici (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(100) DEFAULT NULL, status VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_ADBCB269E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, email VARCHAR(150) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, subject VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, message VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, comment VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, status VARCHAR(10) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, created_at DATETIME DEFAULT \'current_timestamp()\', updated_at DATETIME DEFAULT \'current_timestamp()\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, email VARCHAR(150) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, password VARCHAR(150) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, type VARCHAR(50) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, status VARCHAR(20) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, created_at DATETIME DEFAULT \'NULL\', updated_at DATETIME DEFAULT \'NULL\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('DROP TABLE kullanici');
